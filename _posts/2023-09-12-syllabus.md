...
- [Liam Smith](lwsmith@middlebury.edu) available in 632 from 7:30pm to 9:30pm Mondays 
...
5. Centralized course [Discussions for Fall 2023](https://github.com/opengisci/FA23)
...
For private feedback on assignmnets, we will use individual Google documents in our class [Google Drive folder](https://drive.google.com/drive/folders/1PjSrI5PW_E6A0Ddf9Eq19yKDGSVsYesX?usp=sharing). 
Feel free to add comments in response to anything in your feedback document, e.g. to notify me that you have revised an assignment or that I have overlooked something.
...
- Enrolled students may access literature for the course [here](https://www.github.com/opengisci/literature)
